...
import { useIsMobile } from "@factory/hooks/use-mobile"
...
import { Separator } from "@factory/components/ui/separator"
import {
  Sheet,
  SheetContent,
  SheetDescription,
  SheetHeader,
  SheetTitle,
} from "@factory/components/ui/sheet"
...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from "@factory/components/ui/tooltip"
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile}>
        <SheetContent
          ...
          data-mobile="true"
          className={cn(
            "h-full w-[var(--sidebar-width)] border-sidebar-border bg-sidebar p-0 text-sidebar-foreground shadow-xl !bg-[var(--sidebar)] [&>button]:hidden",
            className,
          )}
          style={
            {
        ...
        >
          ...
          <div className="flex h-full min-h-svh w-full flex-col bg-[var(--sidebar)]">{children}</div>
        </SheetContent>
      </Sheet>
    )
  }
