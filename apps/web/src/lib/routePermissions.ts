...
export const ROUTE_REQUIRED_PERMISSION: Record<string, string> = {
  ...
  "/production": "production:hub:view",
  "/import-export": "import_export:import",
  "/workforce": "workforce:view",
  "/projects/hub": "projects:hub:view",
  "/dev/project-atlas": "admin:permissions:view",
  "/dev/tools": "admin:permissions:view",
  "/dashboard/factory": "dashboard:view",
};
