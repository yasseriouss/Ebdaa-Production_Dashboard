...
import {
  ...
  useListMetalStages, useListWoodenStages,
            ...
            <div>
              ...
              <div className="space-y-2">
                {project.metalOrders.map((o: any) => (
                  <Link key={o.id} href={`/metal/orders/${o.id}`} className="block p-3 rounded-xl bg-foreground/[0.02] hover:bg-foreground/[0.05] transition-colors border border-foreground/5">
            ...
            <div>
              ...
              <div className="space-y-2">
                {project.woodenOrders.map((o: any) => {
                  ...
                  return (
                    <Link key={o.id} href={`/wooden/orders/${o.id}`} className="block p-3 rounded-xl bg-foreground/[0.02] hover:bg-foreground/[0.05] transition-colors border border-foreground/5">
                      <div className="flex justify-between items-center">
    ...
    >
      <header className="space-y-2">
        ...
        <p className="text-muted-foreground font-medium max-w-3xl leading-relaxed">
          عرض وإدارة المشاريع عبر المصنعين مع إحصائيات مجمّعة.{" "}
          <span className="text-foreground/85">
            كل مشروع هنا هو مجموعة أوامر شغل مرتبطة بنفس الاسم/المشروع الفرعي؛ والعميل الواحد قد يظهر في أكثر من مشروع، ولكل مشروع عدة أوامر.
          </span>
        </p>
      </header>
      ...
      <div className="flex gap-2">
        <button onClick={() => setViewTab("browse")}
          className={cn("flex items-center gap-2 px-6 py-3 rounded-2xl text-sm font-bold transition-all duration-300",
