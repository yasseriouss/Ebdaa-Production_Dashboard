  ...
  return (
    ...
    >
      <header className="space-y-2">
        <h1 className="text-3xl font-bold text-foreground sm:text-4xl md:text-5xl">القوة البشرية</h1>
        <p className="text-base text-muted-foreground font-medium sm:text-lg">
          إدارة الموظفين — مصنع الأخشاب والأثاث WF-001
        </p>
      </header>
